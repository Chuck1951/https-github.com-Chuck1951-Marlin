...
//#define TM3DAERO_EXTENDED
//#define PETSFANG  //This is the RIGHT mounted version - if using the left mount please use the CUSTOM_PROBE option.
// uncommented line 299 re custom probe, added define servo pin 27 by chuck 4-20-2020
#define CUSTOM_PROBE
...
// per video okay to leave this as ezabl set for 3x3 grid.
#define EZABL_POINTS 3 // chuck 5-19-2020 disabled, different sensor
...
#define EZABL_PROBE_EDGE 15  //  chuck 5-19-2020 left enabled per video
...
#define EZABL_FASTPROBE  // chuck 5-23-2020 enabled to give it a try
...
// uncommented heaters by chuck 4-20-2020 better accuracy DC powered heaters
...
// enabled fine babystepping by chuck 4-20-2020
#define FINE_BABYSTEPPING

// added 5-23-2020 to help with babysteps, save with store setting on screen
...
// #define EZABL_OUTSIDE_GRID_COMPENSATION  chuck 5-19-2020 disabled, different sensor
...
//================================================================================
  ...
  *    (0,0)
  */
// defined these offsets from measuring sensor  
...
//  #define TH3D_RGB_STRIP_LED_COUNT 20  chuck 5-19-2020 disabled, different sensor
...
//  #define TITAN_EXTRUDER_STEPS 463  chuck 5-19-2020 disabled, different sensor
...
// #define DUAL_HOTEND_X_DISTANCE 18.0  chuck 5-19-2020 disabled, different sensor
...
//#define HOME_ADJUST changed X to -40 offset from -10 chuck 5-19-2020
#define X_HOME_LOCATION -40  
...
//  uncommented line below to help enable sensor 
//  chuck 4-22-2020  DEFINE THIS LINE 300 ONLY UNDER ENDER 3 CHUCK 5-23-2020
// #define SERVO0_PIN 27
// copied lines below from github page mentioned in 3 fixes
//  chuck 4-22-2020
#if ENABLED(BLTOUCH)
